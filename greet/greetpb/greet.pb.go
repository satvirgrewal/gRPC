...
var file_greet_greetpb_greet_proto_rawDesc = []byte{
	...
	0x67, 0x72, 0x65, 0x65, 0x74, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x06, 0x70, 0x67, 0x72,
	...
	0x70, 0x67, 0x72, 0x65, 0x65, 0x74, 0x2e, 0x47, 0x72, 0x65, 0x65, 0x74, 0x69, 0x6e, 0x67, 0x52,
	...
	0x63, 0x65, 0x12, 0x36, 0x0a, 0x05, 0x47, 0x72, 0x65, 0x65, 0x74, 0x12, 0x14, 0x2e, 0x70, 0x67,
	0x72, 0x65, 0x65, 0x74, 0x2e, 0x47, 0x72, 0x65, 0x65, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73,
	0x74, 0x1a, 0x15, 0x2e, 0x70, 0x67, 0x72, 0x65, 0x65, 0x74, 0x2e, 0x47, 0x72, 0x65, 0x65, 0x74,
...
var file_greet_greetpb_greet_proto_goTypes = []interface{}{
	(*Greeting)(nil),      // 0: pgreet.Greeting
	(*GreetRequest)(nil),  // 1: pgreet.GreetRequest
	(*GreetResponse)(nil), // 2: pgreet.GreetResponse
}
var file_greet_greetpb_greet_proto_depIdxs = []int32{
	0, // 0: pgreet.GreetRequest.greeting:type_name -> pgreet.Greeting
	1, // 1: pgreet.GreetService.Greet:input_type -> pgreet.GreetRequest
	2, // 2: pgreet.GreetService.Greet:output_type -> pgreet.GreetResponse
...
func (c *greetServiceClient) Greet(ctx context.Context, in *GreetRequest, opts ...grpc.CallOption) (*GreetResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/pgreet.GreetService/Greet", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _GreetService_Greet_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/pgreet.GreetService/Greet",
	}
...
var _GreetService_serviceDesc = grpc.ServiceDesc{
	ServiceName: "pgreet.GreetService",
