...
func (x *AdditionRequest) GetFirstNumber() float32 {
	if x != nil {
...
func (x *AdditionRequest) GetSecondNumber() float32 {
	if x != nil {
...
func (x *AdditionResponse) GetSum() float32 {
	if x != nil {
		return x.Sum
	}
	return 0
...
var file_calculatorpb_calculator_proto_rawDesc = []byte{
	...
	0x0a, 0x63, 0x61, 0x6c, 0x63, 0x75, 0x6c, 0x61, 0x74, 0x6f, 0x72, 0x22, 0x59, 0x0a, 0x0f, 0x41,
	0x64, 0x64, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x21,
	0x0a, 0x0c, 0x66, 0x69, 0x72, 0x73, 0x74, 0x5f, 0x6e, 0x75, 0x6d, 0x62, 0x65, 0x72, 0x18, 0x01,
	0x20, 0x01, 0x28, 0x02, 0x52, 0x0b, 0x66, 0x69, 0x72, 0x73, 0x74, 0x4e, 0x75, 0x6d, 0x62, 0x65,
	...
	0x4e, 0x75, 0x6d, 0x62, 0x65, 0x72, 0x22, 0x24, 0x0a, 0x10, 0x41, 0x64, 0x64, 0x69, 0x74, 0x69,
	0x6f, 0x6e, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x10, 0x0a, 0x03, 0x73, 0x75,
	0x6d, 0x18, 0x01, 0x20, 0x01, 0x28, 0x02, 0x52, 0x03, 0x73, 0x75, 0x6d, 0x32, 0x5a, 0x0a, 0x0a,
	0x43, 0x61, 0x6c, 0x63, 0x75, 0x6c, 0x61, 0x74, 0x6f, 0x72, 0x12, 0x4c, 0x0a, 0x0d, 0x41, 0x64,
	0x64, 0x54, 0x77, 0x6f, 0x4e, 0x75, 0x6d, 0x62, 0x65, 0x72, 0x73, 0x12, 0x1b, 0x2e, 0x63, 0x61,
	0x6c, 0x63, 0x75, 0x6c, 0x61, 0x74, 0x6f, 0x72, 0x2e, 0x41, 0x64, 0x64, 0x69, 0x74, 0x69, 0x6f,
	0x6e, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x1c, 0x2e, 0x63, 0x61, 0x6c, 0x63, 0x75,
...
var file_calculatorpb_calculator_proto_depIdxs = []int32{
	0, // 0: calculator.Calculator.AddTwoNumbers:input_type -> calculator.AdditionRequest
	1, // 1: calculator.Calculator.AddTwoNumbers:output_type -> calculator.AdditionResponse
...
type CalculatorClient interface {
	// Unary
	AddTwoNumbers(ctx context.Context, in *AdditionRequest, opts ...grpc.CallOption) (*AdditionResponse, error)
}
...
func (c *calculatorClient) AddTwoNumbers(ctx context.Context, in *AdditionRequest, opts ...grpc.CallOption) (*AdditionResponse, error) {
	out := new(AdditionResponse)
	err := c.cc.Invoke(ctx, "/calculator.Calculator/AddTwoNumbers", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CalculatorServer interface {
	// Unary
	AddTwoNumbers(context.Context, *AdditionRequest) (*AdditionResponse, error)
}
...
func (*UnimplementedCalculatorServer) AddTwoNumbers(context.Context, *AdditionRequest) (*AdditionResponse, error) {
...
func _Calculator_AddTwoNumbers_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(AdditionRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CalculatorServer).AddTwoNumbers(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/calculator.Calculator/AddTwoNumbers",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CalculatorServer).AddTwoNumbers(ctx, req.(*AdditionRequest))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _Calculator_AddTwoNumbers_Handler,
		},
	},
